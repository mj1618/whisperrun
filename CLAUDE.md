...
- **In Progress:** Guard Alert Escalation — when a guard spots the Runner (transitions to alert), nearby guards within radius become suspicious and investigate, creating cascading tension; radio chatter sound, expanding ring visual (Runner view), communication lines (Whisper view), difficulty-scaled radius (0/8/12 tiles), cooldown prevents spam, scoring integration as panic moments
